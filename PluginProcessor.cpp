...
{// Récupère l'état actuel de l'APVTS sous forme de ValueTree, 
    // le convertit en XML, puis en binaire dans destData 
...
{ // Reconstruit le XML depuis le binaire reçu de l'hôte
    std::unique_ptr<juce::XmlElement> xmlState (getXmlFromBinary (data, sizeInBytes));
    if(xmlState.get() != nullptr) if (xmlState->hasTagName (parameters.state.getType()))
